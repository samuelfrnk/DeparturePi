...
# Ensure Pygame runs on the correct display
os.environ["DISPLAY"] = ":0"


STATION_ID = os.getenv("STATION_ID", "8503000")
    ...
    if response.status_code == 200:
        ...
        for entry in stationboard:
            ...
            if departure_str != "Unknown":
                ...
                departure_time_local = departure_time.astimezone()  # Convert to local time

                
                time_diff = departure_time_local - current_time
                remaining_minutes = max(0, time_diff.total_seconds() // 60)  # Ensure it's not negative
